                    ...
                    <nav class="navigation-general">
                        <ul class="navigation-general-ul">
                            ...
                            <li class="navigation-general-item">
                                <a href="{{url('/work'.$var->id)}} " class="navigation-general-link">
                                    <span class="label">{{$var->name}}</span>
                                </a>
                            </li>
...
@endsection
@section('main')
   <div id="userpane2" class="container">
        <?php
            $user=Auth()->user();
            ?>
            ...
            <form id="formuser" action="{{url('/edituser'.$user->id)}}" class="form-inline" method="POST" enctype="multipart/form-data">
           {{csrf_field()}}

           <div id="userrow" class="row">

               <label for="name" class="col-md-1"  >Ad:</label>
               <input type="text" name="name" class="form-contr col-md-3 " value="{{$user->name}}" id="name">

               <label for="lastname" class="col-md-1"  >Soyad:</label>
               <input type="text" name="lastname" class="form-contr col-md-3" value="{{$user->lastname}}" id="lastname">
           ...
           <div id="userrow" class="row">
               ...
               <label for="email" class="col-md-1"  >E-Posta:</label>
               <input type="email" name="email" class="form-contr col-md-3 " value="{{$user->email}}" id="email">

               <label for="tel" class="col-md-1"  >Telofon:</label>
               <input type="text" name="tel" class="form-contr col-md-3" value="{{$user->tel}}" id="tel">

           </div>

           <div id="userrow" class="row">

               <label for="tc" class="col-md-1"  >T.C. No:</label>
               <input type="text" name="tc" class="form-contr col-md-3 " value="{{$user->tc}}" id="tc">
           ...
           <div id="userrow" class="row">
               ...
               <label for="birndate" class=" form control"  >Doğum Tarihi:</label>
               <input type="date" name="birndate" class="form-contr col-md-3" value="{{$user->birndate}}" id="birndate">
           ...
           <div id="userrow" class="row">
                   ...
                   <?php
                    $user=AUth()->user();
                     $city=$user->city;
                     $city_name=\DB::table('cities')->where('id','=',$city)->first();
                     if($city_name)
                     $city_name=$city_name->name;

               ?>
                   <label class="col-md-1" for="city">Şehir</label>
                   <select  name="city" class=" col-md-3" >
                       ...
                       $districts=\DB::table('districts')->where('id','=',$districts)->first();
                        if($districts)
                         $districts=$districts->name;
                       ?>
                           <label class="col-md-1" for="state">ilçe</label>
               ...
               <?php
                   ...
                   if($sex==1)
                        $sexname='erkek';
                         ...
                         $sexname='kadın';
               ?>
               <label class="col-md-1" for="sex">cinsiyet</label>
               <select  name="sex" class=" col-md-3" >
                   <option value="0">{{$sexname}} </option>
                       <option value=1>erkek</option>
                       <option value=2>kadın</option>

               </select>

               <label for="tel" class="col-md-1"  >Telefon:</label>
               <input type="text" name="tel" class="form-contr col-md-2 " value="{{$user->tel}}" id="tel">
           </div>
           ...
           <div id="userrow" class="row">
               ...
               <label for="region" class="col-md-1"  >Semt:</label>
               <input type="text" name="region" class="form-contr col-md-2 " value="{{$user->region}}" id="region">

               <label for="postcode" class="col-md-2"  >Posta Kodu:</label>
               <input type="text" name="postcode" class="form-contr col-md-2" value="{{$user->postcode}}" id="postcode">

           </div>

           <div id="userrow1" class="row">

               <label for="adress" class="col-md-2"  >adres:</label>


               <textarea rows = "3" cols = "60" name = "adress" class="col-md-6" >
                   {{$user->adress}}
               </textarea><br>
           ...
           <div id="userrow1" class="row">
               ...
               <h2 >FİRMA Bilgileri</h2>

           </div>

           <div id="userrow" class="row">

               <label for="corporation" class="col-md-3"  >Firma Adı:</label>
               <input type="text" name="corporation" class="form-contr col-md-3 " value="{{$user->corporation}}" id="corporation">
           </div>

           <div id="userrow" class="row">

           <label for="taxnum" class="col-md-3"  >Vergi Numarası:</label>
               <input type="text" name="taxnum" class="form-contr col-md-3" value="{{$user->taxname}}" id="taxnum">
           ...
           <div id="userrow" class="row">
               ...
               <label for="taxhome" class="col-md-3"  >Vergi Dairesi:</label>
               <input type="text" name="taxhome" class="form-contr col-md-3" value="{{$user->taxhome}}" id="taxhome">
           ...
           <button id="btn1" type="submit" class="btn btn-success">Bilgileri Kaydet</button>
