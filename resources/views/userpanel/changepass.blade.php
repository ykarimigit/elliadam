...
@section('main')
    <div id="userpanel" class="container btn btn-light">
        ...
        <h2>ŞİFRE DEĞİŞTİR</h2>
        <?php
        $user=Auth()->user();

        ?>

        @if ($message = Session::get('nopass'))
        ...
        @if ($message = Session::get('success'))
         ...
         @endif
        <form id="formuser" action="{{url('/changeuserpass'.$user->id)}}" class="form-inline" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div id="userrow" class="row">
                ...
                <label for="prepass" class="col-md-3"  >Mevcut Şifre</label>
                <input type="password" name="prepass" class="form-contr col-md-5 " id="prepass">
            ...
            <div id="userrow" class="row">
                ...
                <label for="newpass" class="col-md-3"  >Yeni Şifre</label>
                <input type="password" name="newpass" class="form-contr col-md-5 "  id="newpass">
            ...
            <div id="userrow" class="row">
                ...
                <label for="newpass2" class="col-md-3"  >Yeni Şifre (Tekrar)</label>
                <input type="password" name="newpass2" class="form-contr col-md-5 "  id="newpass2">
            ...
            <button id="btn1" type="submit" class="btn btn-success">DEĞİŞTİR</button>
