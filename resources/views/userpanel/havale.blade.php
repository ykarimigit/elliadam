...
@section('main')
    <div id="userpanel" class="container btn btn-light">
        ...
        <form id="formuser" action="{{url('/havalebul'.$user->id)}}" class="form-inline" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div id="userrow" class="row">
                ...
                <label for="order" class="col-md-2"  >Sipariş No</label>
                <input type="text" name="order" class="form-contr col-md-5 " id="order">


            </div>


            <div id="userrow4" class="row">
                ...
                <table class="table">
                    ...
                    <tbody>
                         <tr>
                             ...
                             <td>
                                 NOVPACK AMBALAJ SAN. VE TİC. LTD. ŞTİ.
                             </td>
                             <td>
                                 1048
                             </td>
                             <td>
                                 TR97 0006 2001 0460 0006 2973 98
                             </td>
                             <td>
                                 6297387
                             </td>
                         ...
                         <tr>
                             ...
                             <td>
                                 TR31 0011 1000 0000 0082 8162 22
                             </td>
                             <td>
                                 8281629578
                             </td>
                         ...
                         <tr>
                             ...
                             <td>
                                 TR63 0001 0020 8092 1021 9450 01
                             </td>
                             <td>
                                 92102194-5001
                             </td>
            ...
            <div id="userrow" class="row">
                ...
                <label for="inform" class="col-md-2"  >Bilgi</label>
                <input type="text" name="inform" class="form-contr col-md-5 " id="inform">
            ...
            <button id="btn1" type="submit" class="btn btn-success">Bildirimde Bulun</button>
