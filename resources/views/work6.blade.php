...
@section('main')
    <div id="work" class="container">
        <div class="col-md-8">
            <h1>
                Geri Dönüşüm Kampanyası
            </h1>
            <p>Sitemizden satın alacağınız, aşağıda linki bulunan “GERİ DÖNÜŞÜMLÜ DOYPACK TORBALAR” ı kullandıktan sonra; baskılı, valfli, yırtılmış, yıpranmış bile olsa en az 100 adet olmak koşuluyla aşağıda adresi bulunan E-Ticaret ofisimize ücretsiz olarak gönderebilirsiniz. </p>
        </div>
