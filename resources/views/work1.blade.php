...
@section('main')
    <div id="work" class="container">
       <div class="col-md-8">
            <h1> Baskılı Ürünler </h1>
            <p><span id="sw1"> Baskılı Kargo Poşetleri :</span> Hızlı baskı tekniği ile CEPLİ KARGO POŞETLERİ ve CEPSİZ KARGO POŞETLERİ' ne 500 adetten itibaren, firmanıza yada markanıza özel 4 renge kadar baskı yapılabilmektedir.</p>
       </div>
