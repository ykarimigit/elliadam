        ...
        <div style=" margin-left: 30%" class="row ">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div id="s1" class="panel-heading">Üye ol</div>

                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            {{ csrf_field() }}

                            <div id="reg1" class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                <label id="s2" for="name" class="col-md-4 control-label">Ad</label>
                            ...
                            <div id="reg1" class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                                <label id="s2" for="lastname" class="col-md-4 control-label">SoyAd</label>
                            ...
                            <div id="reg1" class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                <label id="s2" for="email" class="col-md-4 control-label">E-Posta Adres</label>
                            ...
                            <div id="reg1" class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                <label id="s2" for="password" class="col-md-4 control-label">Şifre</label>
                            ...
                            <div id="reg1" class="form-group">
                                <label id="s2" for="password-confirm" class="col-md-4 control-label">Şifre taidi</label>
                            ...
                            <div id="reg1" class="form-group{{ $errors->has('adress') ? ' has-error' : '' }}">
                                <label id="s2" for="adress" class="col-md-4 control-label">adres</label>

                                <div class="col-md-6">

                                    <textarea rows = "3" cols = "60" name = "adress" type="text"  class="col-md-6" >
                            ...
                            <div id="reg1" class="form-group{{ $errors->has('tel') ? ' has-error' : '' }}">
                                <label id="s2" for="tel" class="col-md-4 control-label">telfon</label>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <button id="s5" type="submit" class="btn btn-primary">
                                        Üye
                                    </button>
                                </div>
                            </div>
