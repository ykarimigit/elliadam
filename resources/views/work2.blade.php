...
@section('main')
    <div id="work" class="container">
        <div class="col-md-8">
            ...
            <p><span id="sw1"> Ambalaj Nedir? :</span>  Ürünlerin, tüketiciye ulaştırılması aşamasında, taşınması, korunması, saklanması, satışa sunulması ve üzerindeki bilgilerle ürünü tanıtan ve içeriği hakkında bilgilendiren, herhangi bir malzemeden yapılmış ürünlerdir.
                Yukarıdaki tanımdan da anlaşılabileceği gibi hemen hemen her ürün ambalaja ihtiyaç duyar ve ambalaj doğru seçilmez ise sonuçları, içerisindeki ürünün zarar görüp, bozulup yaratacağı maddi zararlardan da öte sağlık sorunlarına kadar varabilir. </p>
        </div>
