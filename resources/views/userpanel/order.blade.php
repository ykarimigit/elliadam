...
@section('main')
    <div id="userpanel" class="container btn btn-light">
        ...
        <?php
        $user=Auth()->user();
        $var=\DB::table('orders')->where('customer_id','=',$user->id)
                            ->get();
                     ...
                     <td>
                        ...
                        <?php
                          ...
                          switch($st)
                              {
                              case 0:
                                $statuse='Henüz Tamamlanmadı|';
                                 break;
                              case 1:
                                  $statuse='Ödeme Bekliyor';
                                  break;
                              case 2:
                                  $statuse='Kargo Hazır';
                                  break;
                              case 3:
                                  $statuse='Kargoya Verild';
                                  break;
                              case 4:
                                  $statuse='Ödeme Yapıld';
                                  break;
                              case 5:
                                  $statuse='Teslim Edildi';
                                  break;
                              case 6:
                                  $statuse='İptal Edildi|';
                                  break;
                              case 7:
                                  $statuse='İade Edildi|';
                                  break;
                              case 8:
                                  $statuse='Kısmi İade Edildi|';
                                  break;
                              case 9:
                                  $statuse='Onaylandı ';
                                  break;
