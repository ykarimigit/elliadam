...
@section('main')
    <div id="work" class="container">
        <div class="col-md-8">
            ...
            <p> Numune gönderimlerinde ürün ücreti alınmamaktadır, yalnızca kargo bedelini alıcı ödemektedir.
                » Numune gönderimleri Yurtiçi Kargo, Aras Kargo ve Sürat Kargo firmaları ile yapılmaktadır. Bu firmalarla anlaşmanız varsa lütfen belirtiniz, kargo firması belirtilmemiş ise Aras Kargo ile alıcı ödemeli olarak gönderim yapılmaktadır.
                » Kraft karton çanta ve Hava yastıklı ambalaj (Airbed) ürünlerinden numune gönderimi yapılamamaktadır. </p>
        </div>
