                            ...
                            <ul class="navigation-general-ul">
                                ...
                                <li class="navigation-general-item">
                                    <a href="javascript:" class="navigation-general-link">
                                        <span id="sw2" class="label">{{$var->name}}</span>
                                    </a>
                                </li>
    ...
    <div class="row">
        <div class="col-md-6 ">
            <div class="panel panel-default">
                <div class="panel-heading"><span id="s1" >Giriş</span>  </div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label"><span id="s3">E-Posta Address</span></label>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label id="s3" for="password" class="col-md-4 control-label">Şifre</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label>
                                        <input  type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}><span id="s5"> Hatirla</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                <button id="s3" type="submit" class="btn btn-primary">
                                    Giriş
                                </button>

                                <a id="s3" class="btn btn-link" href="{{ route('password.request') }}">
                                    Şifrezi unutmisiniz?
                                </a>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            <div class="panel-heading"> <a class="btn btn-dark" href="{{ route('register') }}"> <span id="reg"  >Yeni Üyelik</span></a></div>
