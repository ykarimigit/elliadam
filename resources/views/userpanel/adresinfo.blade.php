...
@section('main')
    <div id="userpanel" class="container btn btn-light">
       <div class="row">
           <div class="col-md-4">  <h2>ADRES BİLGİLERİ</h2> </div>
           <div class="col-md-8"> <a href="{{url('/newadres')}}" type="button" class="btn btn-dark">Yeni Adres Ekle</a> </div>
       </div>

    <?php
        $user=Auth()->user();
        $var=\DB::table('customer_addresses')->where('customer_id','=',$user->id)
            ->get();
